...
module "loadbalancer" {
  ...
  web_auto_scaling_group_id = module.autoScaling.web_auto_scaling_group_id
  app_auto_scaling_group_id = module.autoScaling.app_auto_scaling_group_id
}
...
module "autoScaling" {
  ...
  web_lb_target_group_arn = module.loadbalancer.web_lb_target_group_arn
  app_lb_target_group_arn = module.loadbalancer.app_lb_target_group_arn
