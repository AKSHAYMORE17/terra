...
variable "internet_load_balancer_id" {
}
variable "internal_load_balancer_id" {
}
variable "private_sub3_id" {
}
variable "private_sub4_id" { 
}
variable "internal_load_balancer_sg_id" {
}
variable "internet_load_balancer_security_group_id" {
}